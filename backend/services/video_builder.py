...
from services.tts import ensure_pipeline_dir
...
async def build_all_formats(
    ...
    """
    from db import get_supabase
    from services.tts import generate_audio, get_default_voice
    from services.media_selector import select_media_for_script
