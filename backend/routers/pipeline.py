...
from models.schemas import PipelineTriggerRequest, PipelineTriggerResponse
from services.gemini import generate_content, save_content, _log_etapa
from services.video_validator import (
    validate_video,
