...
from services.telegram_bot import update_telegram_message, TELEGRAM_API
...
async def _handle_aprovar(video: dict, user: dict, app: dict = None, workspace: dict = None) -> dict:
    ...
    if app and workspace:
        try:
            from services.publisher_orchestrator import publish_all_platforms
            import asyncio
...
async def _handle_regenerar(video: dict, app: dict, user: dict) -> dict:
    ...
    try:
        from routers.pipeline import _process_app
        import asyncio
