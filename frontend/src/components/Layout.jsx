...
const navItems = [
  ...
  { to: '/benchmark', label: 'Benchmark', icon: BenchmarkIcon },
...
function BenchmarkIcon() {
  return (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19V6l-3 3m12 10V9l3 3M5 19h14M8 13l2 2 6-6" />
    </svg>
  )
}
